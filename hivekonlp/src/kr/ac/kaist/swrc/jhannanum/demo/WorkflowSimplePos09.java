...
public class WorkflowSimplePos09 {
	...
	public static void main(String[] args) {
		String path = "//Users/ahikmat/Documents/kh/handic"; //path to base folder
		Workflow workflow1 = WorkflowFactory.getPredefinedWorkflow(path, WorkflowFactory.WORKFLOW_HMM_POS_TAGGER);
		Workflow workflow2 = WorkflowFactory.getPredefinedWorkflow(path, WorkflowFactory.WORKFLOW_POS_SIMPLE_09);
